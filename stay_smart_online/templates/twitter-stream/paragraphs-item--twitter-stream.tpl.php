...
<div class="twitter-stream spacer">
    ...
    <a class="twitter-account" href="https://twitter.com/CommsAu">
      <img class="twitter-account__avatar" src="<?php print base_path() . drupal_get_path('theme', 'stay_smart_online'); ?>/sass/components/twitter-account/twitter-avatar.png" alt="@CommsAu avatar" />
