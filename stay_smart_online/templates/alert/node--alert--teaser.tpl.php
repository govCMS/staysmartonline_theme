...
<div class="alert-list__item alert <?php print !empty($alert_priority) ? strtolower(trim('alert-priority-'.$alert_priority)) : ''; ?>">
  ...
  <h3 class="alert-list__title"><a href="<?php print $node_url; ?>"><?php print stay_smart_online_trim(render($title), 50); ?></a></h3>

  <?php print render($content['body']); ?>

  <?php print stay_smart_online_read_more_link($node_url, $read_more_text, $external_source); ?>
</div>
